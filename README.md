# WeightedIntervalScheduling
 ...
 # User Manual:
 To run this you should just be able to pull the repository and run it in any python IDE you wish. I utilized Python 3.9, in the Pycharm IDE if you wish to do the same. Make sure all CSV files are in the same folder as the main.py file. When you run the program, when prompted, enter the names of the three CSV files I have provided to test. 
